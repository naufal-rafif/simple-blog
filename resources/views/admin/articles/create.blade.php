                            ...
                            <div class="table-roll w-full overflow-x-auto">
                                <table class="table-auto w-full mb-5">
                                    ...
                                    <tbody class="text-gray-600 text-sm font-light" id="tableModalList">
                                        <form method="POST" action="{{ route('tags.create') }}" autocomplete="off">
                                            @csrf
                                            ...
                                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                                ...
                                                <td class="py-3 px-3 text-center">
                                                    <div class="flex item-center justify-center">
                                                        ...
                                                        <button class="mx-2 px-2 py-1 border-2 border-green-600 text-green-600 rounded-lg text-sm hover:bg-green-500 hover:text-white saveButton hidden" data-name="{{$tag->name}}" data-color="{{$tag->color}}" data-background="{{$tag->background}}" data-route="{{ route('tags.update',$tag->id) }}">simpan</button>
                                                        <button class="mx-2 px-2 py-1 bg-white border-2 border-red-600 text-red-600 rounded-lg text-sm hover:bg-red-800 hover:text-white deleteButton show" data-route="{{ route('tags.destroy',$tag->id) }}">hapus</button>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforeach
